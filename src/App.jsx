...
const App = () => {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      update() {
        // Move particles toward mouse with some easing
  ...
  return (
    <div className="font-sans text-white bg-black min-h-screen overflow-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-95 backdrop-blur-sm border-b border-gray-800">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-yellow-400 text-black px-6 py-2 rounded-full font-medium hover:bg-yellow-300 transition-all shadow-lg hover:shadow-yellow-500/30">
              GET IN TOUCH
            </button>
          </nav>
          <button 
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black border-t border-gray-800 py-6 px-4">
            <ul className="space-y-4">
              ...
              <li>
                <button className="bg-yellow-400 text-black w-full py-3 rounded-full font-medium mt-2 hover:bg-yellow-300 transition-colors">
                  GET IN TOUCH
                </button>
              </li>
            </ul>
      ...
      <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="inline-block px-4 py-1.5 mb-8 bg-yellow-400/10 border border-yellow-400/30 rounded-full backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
            <button className="bg-yellow-400 text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-yellow-300 transition-all shadow-lg hover:shadow-yellow-500/50 transform hover:-translate-y-1">
              ESTIMATE PROJECT
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-black transition-all transform hover:-translate-y-1">
              VIEW OUR WORK
            </button>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-8 text-center">
            <div className="px-4">
              <div className="text-3xl md:text-4xl font-bold text-yellow-400 mb-1">1857</div>
              <div className="text-sm text-gray-400">Reviews across platforms</div>
            </div>
            <div className="px-4">
              <div className="text-3xl md:text-4xl font-bold text-yellow-400 mb-1">50</div>
              <div className="text-sm text-gray-400">Top development companies</div>
            </div>
            <div className="px-4">
              <div className="text-3xl md:text-4xl font-bold text-yellow-400 mb-1">4.9/5</div>
              <div className="text-sm text-gray-400">Average client rating</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="py-24 bg-black relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4 text-yellow-400">Our Services</h2>
            ...
            {[
              {
                ...
                icon: (
                  <svg className="w-12 h-12 text-yellow-400 mx-auto mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div 
                key={index} 
                className="group relative bg-gray-900 border border-gray-800 rounded-2xl p-8 overflow-hidden transition-all duration-300 hover:transform hover:-translate-y-2 hover:border-yellow-400/50 cursor-pointer"
              >
      ...
      {/* Portfolio Section */}
      <section id="projects" className="py-24 bg-gradient-to-b from-black to-gray-900 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4 text-yellow-400">Featured Projects</h2>
            <p className="text-lg text-gray-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="group relative rounded-xl overflow-hidden h-72 transform transition-all duration-300 hover:scale-[1.02]">
                <div className={`absolute inset-0 ${project.bg} border border-yellow-400/20`} />
                <div className="absolute inset-0 flex items-end p-6">
                  <div className="relative z-10 text-white">
                    <h3 className="text-xl font-bold mb-1">{project.title}</h3>
                    <p className="text-yellow-300 font-medium">{project.category}</p>
                  </div>
                </div>
      ...
      {/* Stats Section */}
      <section className="py-20 bg-black border-y border-gray-800 relative z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={index} className="p-6">
                <div className="text-4xl md:text-5xl font-black text-yellow-400 mb-2">{stat.number}</div>
      ...
      <section className="py-24 bg-gradient-to-b from-black to-gray-900 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4 text-yellow-400">What Our Clients Say</h2>
            <p className="text-lg text-gray-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index} 
                className="bg-gray-900 border border-gray-800 rounded-2xl p-8 relative before:content-[''] before:absolute before:top-0 before:left-4 before:w-1 before:h-12 before:bg-yellow-400 before:rounded-full"
              >
                <p className="text-gray-300 italic mb-6 relative z-10">{testimonial.text}</p>
                <div>
                  <div className="font-bold text-yellow-300">{testimonial.author}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-black text-yellow-400">Let's Build Something Amazing Together</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input
                  ...
                  required
                  className="bg-gray-900 border border-gray-800 rounded-xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
                />
                <input
                  type="email"
                  name="email"
              ...
              <textarea
                ...
                onChange={handleInputChange}
                required
                className="bg-gray-900 border border-gray-800 rounded-xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent w-full"
              ></textarea>
              <button 
                type="submit" 
                className="bg-yellow-400 text-black w-full py-4 rounded-xl font-bold text-lg hover:bg-yellow-300 transition-all shadow-lg hover:shadow-yellow-500/50 transform hover:-translate-y-1"
              >
                Send Message
              </button>
            </form>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-gray-800 bg-black relative z-10">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
            <div className="text-yellow-400 font-bold text-2xl tracking-tight">KUGI TECH</div>
            ...
            <div className="flex space-x-6">
              {['𝕏', 'in', 'GH'].map((icon, index) => (
                <a 
                  key={index} 
                  href="#" 
                  className="w-10 h-10 rounded-full border border-gray-800 flex items-center justify-center text-gray-400 hover:text-yellow-400 hover:border-yellow-400 transition-all"
                >
                  {icon}
                </a>
              ))}
